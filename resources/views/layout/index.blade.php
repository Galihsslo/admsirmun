        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="/role/admin"><img
                            src="{{ asset('Assets') }}/images/SIMUNIR.png" alt="logo" /></a>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="pages/samples/login.html"> Bendahara
                                    </a></li>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a
                                href="https://sentramediadevelopment.tech/"
                                target="_blank">sentramediadevelopment.tech </a>2021</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Only the best <a
                                href="https://sentramediadevelopment.tech" target="_blank"> Galih's </a>
                            templates</span>
                    </div>
                </footer>
                <!-- partial -->
